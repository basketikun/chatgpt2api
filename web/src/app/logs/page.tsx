...
const typeLabels: Record<string, string> = {
  [LogType.Call]: "Call Log",
  [LogType.Account]: "Account Management Log",
};
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          <Select value={type} onValueChange={setType}>
            ...
            <SelectContent>
              <SelectItem value={LogType.Call}>Call Log</SelectItem>
              <SelectItem value={LogType.Account}>Account Management Log</SelectItem>
            </SelectContent>
          </Select>
            ...
            <Table className="min-w-[900px]">
              <TableHeader>
                <TableRow>
                  ...
                  {isCallLog ? <TableHead>Call Duration</TableHead> : null}
        ...
        <DialogContent showCloseButton={false} className="rounded-2xl p-6">
          <DialogHeader className="gap-2">
            ...
            <DialogDescription className="text-sm leading-6">
              Confirm deleting {deletingItems.length} logs? This cannot be recovered.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
