      ...
      <CardContent className="space-y-6 p-6">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-stone-500">Configure connections first, then query remote accounts and import to local pool as needed.</p>
            </div>
          </div>
        ...
        {isLoadingPools ? (
          ...
          <div className="flex flex-col items-center justify-center gap-3 rounded-xl bg-stone-50 px-6 py-10 text-center">
            ...
            <div className="space-y-1">
              <p className="text-sm font-medium text-stone-600">No CPA connections yet</p>
              <p className="text-sm text-stone-400">Click "Add Connection" to save your CLIProxyAPI info.</p>
            </div>
          </div>
        ) : (
        ...
        <div className="rounded-xl bg-stone-50 px-4 py-3 text-sm leading-6 text-stone-500">
          ...
          <ul className="mt-1 list-inside list-disc space-y-0.5">
            <li>The page will first read CPA connections configured in the system.</li>
            <li>Click "Sync" on a connection to read the remote account list and display for frontend selection.</li>
            <li>After confirming the selection, the backend downloads corresponding access_tokens and imports them to the local pool.</li>
            <li>The frontend only polls import progress and does not directly participate in downloads.</li>
          </ul>
        </div>
      </CardContent>
    </Card>
