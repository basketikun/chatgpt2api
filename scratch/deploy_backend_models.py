...
def main():
    ...
    files_to_deploy = [
        (r"d:\Chatgpt\chatgpt2api\chatgpt2api-1\services\protocol\openai_v1_models.py", "chatgpt2api:/app/services/protocol/openai_v1_models.py"),
        (r"d:\Chatgpt\chatgpt2api\chatgpt2api-1\utils\helper.py", "chatgpt2api:/app/utils/helper.py")
    ]
    ...
    try:
        ...
        print("Deployment of backend models successful!")
